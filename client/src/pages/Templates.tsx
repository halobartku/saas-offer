...
export default function Templates() {
  ...
  async function handleCreateFromTemplate(template: OfferTemplate) {
    try {
      ...
      // Navigate to create offer form with template data
      // This will be implemented in the OfferForm component
    } catch (error) {
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to use template",
        variant: "destructive",
      });
    }
  }
        ...
        <TableBody>
          {filteredTemplates?.map((template) => (
            <TableRow key={template.id}>
              ...
              <TableCell>{template.defaultValidityDays} days</TableCell>
